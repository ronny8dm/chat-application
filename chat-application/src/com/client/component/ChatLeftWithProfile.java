...
public class ChatLeftWithProfile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new com.client.swing.ImageAvatar();
        txt = new com.client.component.ChatItem();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/client/icon/testing/dog.jpg"))); // NOI18N
    ...
    private com.client.swing.ImageAvatar IaImage;
