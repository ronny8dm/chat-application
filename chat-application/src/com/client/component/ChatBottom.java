...
import com.client.swing.JIMSendTextPane;
...
public class ChatBottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/client/icon/send.png")));
        ...
        cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/client/icon/more_disable.png")));
        cmdMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (panelMore.isVisible()) {
                    ...
                    cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/client/icon/more.png")));
