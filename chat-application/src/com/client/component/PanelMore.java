...
import com.client.emoji.Model_Emoji;
import com.client.event.PublicEvent;
import com.client.main.Main;
...
import com.client.swing.WrapLayout;
...
public class PanelMore extends javax.swing.JPanel {
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/client/icon/image.png")));
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/client/icon/link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();
