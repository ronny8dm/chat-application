...
import com.client.event.EventImageView;
import com.client.event.EventMain;
import com.client.event.PublicEvent;
import com.client.model.ModelUserAccount;
import com.client.service.Service;
import com.client.swing.ComponentResizer;
import com.client.swing.blurHash.*;
...
public class Main extends javax.swing.JFrame {
    ...
    private void init() {
        setIconImage(new ImageIcon(getClass().getResource("/com/client/icon/icon.png")).getImage());
    ...
    private void initComponents() {
        ...
        loading = new com.client.form.Loading();
        login = new com.client.form.Login();
        vIew_Image = new com.client.form.ViewImage();
        home = new com.client.form.Home();
        ...
        background.setBackground(new java.awt.Color(37, 29, 58));
        ...
        cmdMinimize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/client/icon/minimize.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/client/icon/close.png"))); // NOI18N
    ...
    private com.client.form.Home home;
    private com.client.form.Loading loading;
    private com.client.form.Login login;
    private javax.swing.JPanel title;
    private com.client.form.ViewImage vIew_Image;
